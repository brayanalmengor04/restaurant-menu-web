            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(Str::limit($user->username, 15, '...')); ?></td>
                        <td><?php echo e(Str::limit($user->email, 20, '...')); ?></td>
                        <td><?php echo e(Str::limit($user->contact_name, 20, '...')); ?></td>
                        <td><?php echo e(Str::limit($user->restaurant_name, 20, '...')); ?></td>
                        <td>
                            <span class="badge 
                                <?php echo e($user->status === 'Active' ? 'bg-success' : 'bg-danger'); ?>">
...
<?php echo $__env->make("template.sectiontemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u426645434/domains/escueladeprogramacion.net/public_html/grupos/grupo1/resources/views/template/user/index.blade.php ENDPATH**/ ?>