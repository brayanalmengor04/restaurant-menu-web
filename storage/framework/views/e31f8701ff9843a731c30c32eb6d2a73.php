...
unset($__errorArgs, $__bag); ?>
                 ...
                 <!-- User Type Field -->
                    <?php if(Auth::check() && Auth::user()->user_type == "admin"): ?>
                        <!-- Si el usuario está autenticado como administrador, se desglosan todas las opciones -->
                        <div class="col-12">
                            <div class="form-floating">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php else: ?>
                        <!-- Si el usuario no está autenticado o no es administrador, solo permite la selección de "Customer" -->
                        <div class="col-12">
                            <div class="form-floating">
                                <select class="form-control <?php $__errorArgs = ['user_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php echo $__env->make("template.sectiontemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\restaurant-menu-web\resources\views/template/user/create.blade.php ENDPATH**/ ?>