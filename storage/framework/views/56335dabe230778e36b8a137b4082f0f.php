    ...
    <div class="card-body p-5"> 
        ...
        >
            <button
                ...
                aria-label="Close"
            ></button>
            <strong>invalid credentials</strong> <?php echo e(session('message')); ?>
        ...
        <form method="POST" action="<?php echo e(route('loginpost')); ?>">
            ...
            <div class="text-center mt-4 fs-6">
                <a href="<?php echo e(route('user.create')); ?>" class="d-block">Don’t have an account? Sign Up</a>
...
<?php /**PATH /home/u426645434/domains/escueladeprogramacion.net/public_html/grupos/grupo1/resources/views/login.blade.php ENDPATH**/ ?>