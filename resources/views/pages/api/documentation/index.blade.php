...
@section("title", "PanamaApi Documentation")
@section("section-title", "Panama API - Interactive Documentation")
@section("content") 
    ...
    <div class="row">
        ...
        <main class="col-md-9">
            ...
            <section id="districts" class="mb-5">
                ...
                <code>GET {{ $endpoints['districts'] }}</code>
            ...
            <section id="district-by-id" class="mb-5">
                ...
                <code>GET {{ $endpoints['district_by_id'] }}</code>
                <div class="response-box mt-3 scroll-container">
                    <h6 class="text-muted">Sample Response</h6>
            ...
            <section id="provinces" class="mb-5">
                ...
                <code>GET {{ $endpoints['provinces'] }}</code>
                <div class="response-box mt-3 scroll-container">
                    <h6 class="text-muted">Sample Response</h6>
            ...
            <section id="province-by-id" class="mb-5">
                ...
                <code>GET {{ $endpoints['province_by_id'] }}</code>
                <div class="response-box mt-3 scroll-container">
                    <h6 class="text-muted">Sample Response</h6>
            ...
            <section id="corregimientos" class="mb-5">
                ...
                <code>GET {{ $endpoints['corregimientos'] }}</code>
                <div class="response-box mt-3 scroll-container">
                    <h6 class="text-muted">Sample Response</h6>
            ...
            <section id="corregimiento-by-id" class="mb-5">
                ...
                <code>GET {{ $endpoints['corregimiento_by_id'] }}</code>
                <div class="response-box mt-3 scroll-container">
                    <h6 class="text-muted">Sample Response</h6>
