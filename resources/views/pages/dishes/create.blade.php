            ...
            <div class="col-lg-7 col-md-12">
                ...
                <form action="{{ route('dish.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('dish_name') is-invalid @enderror" id="dish_name" name="dish_name" value="{{ old('dish_name') }}" placeholder="Dish Name*" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <textarea class="form-control @error('dish_description') is-invalid @enderror" id="dish_description" name="dish_description" placeholder="Dish Description">{{ old('dish_description') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="number" class="form-control @error('dish_price') is-invalid @enderror" id="dish_price" name="dish_price" value="{{ old('dish_price') }}" placeholder="Dish Price*" step="0.01" required>
